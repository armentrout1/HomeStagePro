export const GLOBAL_GUARDRAILS = [
  ...
  "WINDOW CLEARANCE RULE (MUST FOLLOW): NEVER place ANY furniture or decor in front of, across, or directly under a window if it overlaps any part of the glass area. Keep the entire window opening (glass) fully visible and unobstructed. If a placement risks blocking a window even slightly, OMIT that furniture item.",
